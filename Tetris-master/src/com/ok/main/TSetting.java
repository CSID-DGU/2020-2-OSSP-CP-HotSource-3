...
public class TSetting extends JFrame {
	...
	public TSetting(TMain main) {
		...
		viewleft.setFont(new Font("���� ���", Font.BOLD, 13));
		viewright.setFont(new Font("���� ���", Font.BOLD, 13));
		viewrotate.setFont(new Font("���� ���", Font.BOLD, 13));
		viewdown.setFont(new Font("���� ���", Font.BOLD, 13));
		viewdrop.setFont(new Font("���� ���", Font.BOLD, 13));
		viewhold.setFont(new Font("���� ���", Font.BOLD, 13));
